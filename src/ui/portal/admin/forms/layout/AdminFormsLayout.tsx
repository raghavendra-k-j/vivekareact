...
import { AdminFormsModuleLayoutContext } from "./AdminFormsLayoutContext";
...
function PageProvider() {
    ...
    return (
        <AdminFormsModuleLayoutContext.Provider value={storeRef.current}>
            <div className="w-full h-full overflow-y-hidden">
                <Outlet />
            </div>
        </AdminFormsModuleLayoutContext.Provider>
    );
}
