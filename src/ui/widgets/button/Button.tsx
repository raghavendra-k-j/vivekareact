...
const buttonStyles = cva(
    "inline-flex items-center justify-center font-medium rounded-[var(--dimen-button-radius)] px-4 py-2 focus:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed gap-2 whitespace-nowrap",
    {
        variants: {
            size: {
